// loan simulator ask the user questions on the loan.
function loanSimulator() {
    let loanAmount = parseInt(prompt("Enter loan amount"));
    let loanTerm = parseInt(prompt("Enter length of term. Up to 72 Months"));
    ...
    if (loanTerm >= 1 && loanTerm <= 72) {
        ...
        console.warn("You exceeded the loan max terms of 72 months. Please try again.");
    }
}
